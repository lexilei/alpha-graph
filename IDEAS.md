...
| liquidity-volume | **已开 2026-07-17;C30 candidate / C31 rejected** | 预算钉(账本):≤3 primaries、deadline 2026-08-28、stop \|t\|<1.5 → 永久关、reopen 2.0;**C30=I21 volume_trend:sn incr t=−3.12,candidate,账本最强 primary(首越 E[max]-null 2.90;5% FW 3.59 未过)**;**C31=I14 GKM 事件式:sn incr t=−0.10 → rejected(2026-07-18,与 P=2 先验一致)**;余 1 保留 primary 名额(member 3 须 deadline 前另行预注册);I9 ILLIQ / I13 turnover 双源发表后死 → P=1、U1 条件、不占预算;HXZ trading-frictions 类 NYSE-VW 复现率仅 3.8%(102/106 FAIL) |
