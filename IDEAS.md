...
| liquidity-volume | **已开 2026-07-17;member 1 = candidate** | 预算钉(账本):≤3 primaries(I21/I14 + 1 保留)、deadline 2026-08-28、stop \|t\|<1.5 → 永久关、reopen 2.0;**C30=I21 volume_trend 当日评估:sn incr t=−3.12,candidate,账本最强 primary(首越 E[max]-null 2.90;5% FW 3.59 未过)**,stop 条件已被 member 1 满足,余 2 primary 名额(I14 + 1 保留);I9 ILLIQ / I13 turnover 双源发表后死 → P=1、U1 条件、不占预算;**I14 GKM → C31(2026-07-18 注册,member 2,事件式构造)**;HXZ trading-frictions 类 NYSE-VW 复现率仅 3.8%(102/106 FAIL) |
