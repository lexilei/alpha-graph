...
| liquidity-volume | **已开 2026-07-17**(C30=I21 注册) | 预算钉(账本):≤3 primaries(I21/I14 + 1 保留)、deadline 2026-08-28、stop \|t\|<1.5 → 永久关、reopen 2.0;I21 volume_trend 家族最强(OSAP 发表后 5.08、2011+ 3.84,trading 类唯一现代存活者;EW 全 universe + HXZ 无判决 → P=2)→ **C30**;I9 ILLIQ / I13 turnover 双源发表后死 → P=1、U1 条件、不占预算;I14 GKM 双源均无追踪 → P=2,member 2 候选;HXZ trading-frictions 类 NYSE-VW 复现率仅 3.8%(102/106 FAIL) |
