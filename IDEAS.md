...
| ownership-flow | **已开 2026-07-20**(C34=I6 注册) | pin:≤2 primaries(I6 + I5 建好 13F 管道后另注册)、deadline 2026-08-31、stop 1.5、reopen 2.0;**C34**:FINRA 合并空头持仓(2021-06 起才含上市名,~57 月短面板,MDE≈0.017 注册时言明)÷ shares_asof(C33 审计条款:filed≤avail);I6 先验依赖 U1 的部分(难借券段)不变 |
